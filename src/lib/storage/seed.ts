...
export function initializeDemoData(): void {
  ...
  const users: User[] = [
    ...
    { id: 'u2', email: 'institution@scholarx.local', name: 'Rahim Ahmed', password: 'admin123', role: 'INSTITUTION_ADMIN', institutionId: 'i1', createdAt: '2025-01-15T00:00:00Z', updatedAt: '2025-01-15T00:00:00Z' },
    { id: 'u4', email: 'admin@dhaka-academy.bd', name: 'Nusrat Jahan', password: 'admin123', role: 'INSTITUTION_ADMIN', institutionId: 'i2', createdAt: '2025-01-20T00:00:00Z', updatedAt: '2025-01-20T00:00:00Z' },
    { id: 'u5', email: 'admin@barisal-school.bd', name: 'Kamal Hossain', password: 'admin123', role: 'INSTITUTION_ADMIN', institutionId: 'i3', createdAt: '2025-02-01T00:00:00Z', updatedAt: '2025-02-01T00:00:00Z' },
  ];
