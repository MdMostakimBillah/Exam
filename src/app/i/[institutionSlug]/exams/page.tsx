      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          <CardContent className="p-5">
            ...
            <p className="text-3xl font-bold text-zinc-100 mt-2">{exams.length}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-5">
            <p className="text-xs text-zinc-500 font-medium uppercase tracking-wider">Open</p>
            <p className="text-3xl font-bold text-emerald-400 mt-2">{exams.filter(e => e.status === 'OPEN').length}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-5">
            <p className="text-xs text-zinc-500 font-medium uppercase tracking-wider">Published</p>
            <p className="text-3xl font-bold text-blue-400 mt-2">{exams.filter(e => e.status === 'PUBLISHED').length}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-5">
            <p className="text-xs text-zinc-500 font-medium uppercase tracking-wider">My Registrations</p>
            <p className="text-3xl font-bold text-zinc-100 mt-2">{registrations.length}</p>
          </CardContent>
        </Card>
      </div>
