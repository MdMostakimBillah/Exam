      ...
      <div className="max-w-[1600px] mx-auto p-6 lg:p-8">
        ...
        <div className="mb-8">
          ...
          <p className={`text-sm mt-1 ${isDark ? "text-zinc-500" : "text-zinc-500"}`}>
            {isBn ? 'পরীক্ষার জন্য ক্লাস বিভাগ পরিচালনা করুন' : 'Manage class categories for examinations'}
          </p>
        </div>
        ...
        <div className={`${card}`}>
          ...
          {filtered.length === 0 ? (
            ...
            <Table>
              ...
              <TableBody>
                {filtered.map(cls => (
                  <TableRow key={cls.id} className={`${isDark ? 'border-white/[0.04] hover:bg-white/[0.02]' : 'border-zinc-100 hover:bg-zinc-50/50'} ${selection.isSelected(cls.id) ? ('bg-brand-accent-soft') : ''}`}>
