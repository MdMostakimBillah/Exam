        ...
        <div className={`${card}`}>
          ...
          {filtered.length === 0 ? (
            ...
            <Table>
              ...
              <TableBody>
                {filtered.map((user) => (
                  <TableRow key={user.id} className={`${isDark ? "border-white/[0.04] hover:bg-white/[0.02]" : "border-zinc-100 hover:bg-zinc-50/50"} ${selection.isSelected(user.id) ? ('bg-brand-accent-soft') : ''}`}>
